...
const EditModal = ({ setModal, phonenumber, firstname, lastname,email, id }) => {
  const [edit, setEdit] = useState({firstname:firstname, phonenumber:phonenumber, lastname:lastname,email:email, address:""})
  const handleSubmit = (e) => {
    ...
    updateDoc(docRef,{
      ...edit
    }).then(()=> {toast.success("Success: Updated !"); setModal(false)}).catch((err)=>{toast.error(err); console.log(err);})
  };
  console.log(edit);
...
const Customer = () => {
  ...
  return (
    <>
      {
        generalInfo ? <div className="w-full">
          ...
          <div className="card flex shadow-lg w-4/5 rounded-lg mx-10 bg-white flex-col md:flex-row">
            <div className="flex flex-col justify-center items-center px-20 gap-5 border-r-2 border-[#00000021]">
              ...
              <span className="flex flex-col items-center justify-center font-bold text-xl">
                ...
                <p className="text-emerald-400 text-sm">({tag.stringValue} Customer)</p>
              </span>
              ...
              <div className="flex flex-col px-7  py-7">
                ...
                <div className="flex gap-4">
                  ...
                  <span className="flex gap-3 flex-col md:flex-row">
                    ...
                    <p className="font-bold text-blue-600">{firstname.stringValue}</p>
                  </span>
                  <span className="flex gap-3 flex-col lg:flex-row">
                    <p className="text-gray-500">Last Name:</p>
                    <p className="font-bold text-blue-500">{lastname.stringValue}</p>
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col px-7 py-7">
                ...
                <div className="flex gap-4">
                  ...
                  <span className="flex gap-3">
                    ...
                    <p className="font-bold text-blue-600">+{phonenumber.stringValue}</p>
                  </span>
                </div>
              </div>
        ...
        {showModal && <EditModal setModal={setShowModal} firstname={firstname.stringValue} lastname={lastname.stringValue} email={email.stringValue} phonenumber={phonenumber.integerValue} id={customer} />}
      </div>:<div>Loading...</div>
      }
    </>
  );
